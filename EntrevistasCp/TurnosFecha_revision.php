...
class TurnosFecha {
    ...
    public function __construct($fecha, $tipo = 'entre',$eva) {
        $this->connect();
        $this->loadTurnos($fecha, $tipo,$eva);
    }
