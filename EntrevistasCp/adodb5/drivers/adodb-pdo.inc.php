 ...
 */
echo "<p>DEBUG 1 - INICIO adodb-pdo.inc.php</p>";
// security - hide paths
...
*/
echo "<p>DEBUG 2 - Llegamos a la definición de clase adodb_pdo_type</p>";
...
echo "<p>DEBUG 3 - Llegamos a la definición de clase ADODB_pdo</p>";
