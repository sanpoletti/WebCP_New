...
<html>
	<head>
		<title>Hist&oacute;rico de Indices</title>
...
if( isset($_GET['ntitu']) && !empty($_GET['ntitu']) && isset($_GET['rubs'])) {
	$ntitu = $_GET['ntitu'];
	$nrorub = $_GET['rubs'];
} else {
...
ob_start();
include 'Ficharub.class_OLD.php';
$hIn = new Ficharub($ntitu, $nrorub);
ob_end_clean();
ob_start();
