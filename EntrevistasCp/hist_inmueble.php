...
if( isset($_GET['idpersonahogar']) && !empty($_GET['idpersonahogar'])&& !empty($_GET['idtipo']) ) {
...
$hdInmueble = new InmueblesSintys($idpersonahogar,$idtipo);
ob_end_clean();
ob_start();
echo "<body bgcolor='#e7e8ed'>";
include "gen_hdInmueble.php";
