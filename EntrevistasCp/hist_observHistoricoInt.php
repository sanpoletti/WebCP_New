...
<html>
	<head>
		<title>Hist&oacute;rico de observaciones integrantes</title>
...
$hoHInt =new Entrevistas($ntitu, $idhogar, $nrorub, $numeroconsulta, $idpersonahogar);
ob_end_clean();
ob_start();
echo "<body bgcolor='#e7e8ed'>";
include "gen_hoHInt_pdf.php";
