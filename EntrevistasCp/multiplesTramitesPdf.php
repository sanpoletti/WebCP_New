...
<Body>
		<div id="logo">
			<td><h3 style="text-align:left;color: red;">Adjuntar Tramites Escaneados (Seleccione uno o multiples Pdf.)</h3></td>
...
<body>
    ...
    $fechaCarga=date('d/m/Y');
			    ...
			    # recorremos todos los arhivos que se han subido
			    	...
			    	//if($_FILES["archivo"]["type"][$i]=="image/pdf" || $_FILES["archivo"]["type"][$i]=="image/pjpeg" || $_FILES["archivo"]["type"][$i]=="image/gif" || $_FILES["archivo"]["type"][$i]=="image/png")
			    	...
			    	# si exsite la carpeta o se ha creado
			    			...
			    			$nombrePdf=$numeroConsulta.'-'.limpia_espacios($_FILES["archivo"]["name"][$i].'-'.$fechaCarga);
			    				...
			    				# movemos el archivo
			    						...
			    						// echo "<br>".'-'.$_FILES["archivo"]["name"][$i]."    Adjuntado Correctamente"."<br>";
			    						// echo "<br>".$_FILES["archivo"]["name"][$i]."<script type=\"text/javascript\">alert(\"Adjuntado con Exito\");</script>";
			    ...
			    include_once 'PostlistarTramitesPdf2.php';
