<?php
$observsegH = $hoH->getObservacionesseguiHistorico();


if (!$observsegH->isEmpty())  
{ 
	$observacionessegH = $observsegH->getData();
?>
	<h3 style='text-align:center}'>Historico Observaciones del TITULAR</h3>
	<table style="width: 100%; border: solid 1px black; border-collapse: collapse;" align="center">
		...
		<?php
		$bg_css = ""; // valor por defecto vacío
